...
而对于Prometheus这一类基于Pull模式的监控系统，显然也无法继续使用的static\_configs的方式静态的定义监控目标。而对于Prometheus而言其解决方案就是引入一个中间的代理人（服务注册中心），这个代理人掌握着当前所有监控目标的访问信息，Prometheus只需要向这个代理人询问有哪些监控目标控即可， 这种模式被称为服务发现。

![&#x57FA;&#x4E8E;&#x670D;&#x52A1;&#x53D1;&#x73B0;&#x4E0E;&#x6CE8;&#x518C;&#x4E2D;&#x5FC3;&#x52A8;&#x6001;&#x53D1;&#x73B0;&#x76D1;&#x63A7;&#x76EE;&#x6807;](../../.gitbook/assets/prometheus-sd.png)
...
![Push&#x7CFB;&#x7EDF; vs Pull&#x7CFB;&#x7EDF;](../../.gitbook/assets/pulls_vs_push.png)
