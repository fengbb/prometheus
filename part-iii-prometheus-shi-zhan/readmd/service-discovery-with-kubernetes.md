...
通过指定kubernetes\_sd\_config的模式为node，Prometheus会自动从Kubernetes中发现到所有的node节点并作为当前Job监控的Target实例。如下所示，这里需要指定用于访问Kubernetes API的ca以及token文件路径。
...
![Service Discovery&#x53D1;&#x73B0;&#x7684;&#x5B9E;&#x4F8B;](../../.gitbook/assets/prometheus-k8s-sd-example1.png)
...
![Target&#x9875;&#x9762;&#x72B6;&#x6001;](../../.gitbook/assets/prometheus-k8s-sd-example3.png)
