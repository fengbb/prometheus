...
完成全局SMTP之后，我们只需要为receiver配置email\_configs用于定义一组接收告警的邮箱地址即可，如下所示：
...
每个email\_config中定义相应的接收人邮箱地址，邮件通知模板等信息即可，当然如果当前接收人需要单独的SMTP配置，那直接在email\_config中覆盖即可：
...
如果当前收件人需要接受告警恢复的通知的话，在email\_config中定义`send_resolved`为true即可。
...
![&#x544A;&#x8B66;](../../../.gitbook/assets/mail-alert-page.png)
