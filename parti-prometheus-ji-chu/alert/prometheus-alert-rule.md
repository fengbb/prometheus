...
为了能够让Prometheus能够启用定义的告警规则，我们需要在Prometheus全局配置文件中通过**rule\_files**指定一组告警规则文件的访问路径，Prometheus启动后会自动扫描这些路径下规则文件中定义的内容，并且根据这些规则计算是否向外部发送通知：
...
![&#x544A;&#x8B66;&#x6D3B;&#x52A8;&#x72B6;&#x6001;](../../.gitbook/assets/prometheus-ui-alert.png)
...
![&#x544A;&#x8B66;&#x89C4;&#x5219;](../../.gitbook/assets/prometheus-ui-rules.png)

切换到Alerts标签[http://127.0.0.1:9090/alerts](http://127.0.0.1:9090/alerts)可以查看当前告警的活动状态。

![&#x544A;&#x8B66;&#x6D3B;&#x52A8;&#x72B6;&#x6001;](../../.gitbook/assets/prometheus-ui-alert%20%281%29.png)
